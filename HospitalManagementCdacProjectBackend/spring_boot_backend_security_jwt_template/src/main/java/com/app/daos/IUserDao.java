...
public interface IUserDao extends JpaRepository<User, Long>{
	...
	int updateFirstNameLastNameDobCellNo(@Param("firstName")String firstName,@Param("lastName") String lastName,@Param("dob") LocalDate dob,@Param("cellNo") String cellNo,@Param("userId") int userId);
