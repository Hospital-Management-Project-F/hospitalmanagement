...
@Getter
	...
	@AllArgsConstructor
	@ToString
	public class MedicineAssignDto {
//		pat_id, medicine_id, prescription, medicine_qty, name, price
		...
		public static List<MedicineAssignDto> createMedicineListForPatient(List<MedicineAssign> medicines){
			List<MedicineAssignDto> medicineDtoList=new ArrayList<MedicineAssignDto>();
			
			for(MedicineAssign medicineAssigned:medicines) {
				MedicineAssignDto medicineAssignedDto=new MedicineAssignDto();
		...
		public static List<MedicineAssignDto> createAllMedicineList(List<Medicine> medicines){
			List<MedicineAssignDto> medicineDtoList=new ArrayList<MedicineAssignDto>();
